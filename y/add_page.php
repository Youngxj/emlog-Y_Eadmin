		...
		<div class="col-lg-12">
			<div class="widget float-e-margins">
				<div class="widget-header">
					<h2><i class="fa fa-file-o fa-fw"></i> 新建页面<span id="msg_2"></span></h2>
				...
				<div class="widget-content">
					<form action="page.php?action=add" method="post" enctype="multipart/form-data" id="addlog" name="addlog">
						<div id="post">
							<div class="row">
								<div class="col-md-7">
									<div><input type="text" maxlength="200" name="title" id="title" class="form-control" placeholder="输入页面标题"/><input name="date" id="date" type="hidden" value="" ></div>
									<div id="post_bar">
										<div>
										...
										<div id="FrameUpload" style="display: none;"><iframe style="width:100%;height:330px;" frameborder="0" src="attachment.php?action=selectFile"></iframe></div>
									</div>
									<div>
										<?php if($editType==1):?>
									...
									<div class="col-md-5">
										<div class="panel panel-default">
											...
											<div class="panel-body">
												...
												<input name="alias" id="alias" class="form-control" placeholder="输入链接别名"/>
